...
Division=Button(f2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 25 ,'bold'),text="/",bg="powder blue", command=lambda: btnclick("/") )
Division.grid(row=5,column=3)
status = Label(f2,font=('aria', 15, 'bold'),width = 20, text="-By DIVYANG & VEDANT",bd=2,relief=SUNKEN)
